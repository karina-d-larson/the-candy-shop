...
- [x] **Task:** Remove unused Vite starter files
- **Priority:** High
...
- [x] **Task:** Remove unused Tailwind dependencies
- **Priority:** High
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Trim dead JavaScript helpers
- **Priority:** Medium
...
- [x] **Task:** Consolidate detail view into modal (remove product page route)
- **Priority:** Critical
...
- [x] **Task:** JSON loading with status handling
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Product cards (image, name, price/cost)
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Detail modal (desktop + mobile behavior)
- **Priority:** Critical
...
- [x] **Task:** URL parameter handling (`?id=`)
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Favorites with localStorage
- **Priority:** Critical
- **Estimated Time:** M (30–60 min)
...
- [x] **Task:** Order page + Order Now flow
- **Priority:** Critical
- **Estimated Time:** M (30–60 min)
...
- [x] **Task:** Order count in localStorage
- **Priority:** Critical
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** JavaScript modules organization
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Semantic HTML structure
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Form labels on order page
- **Priority:** Critical
- **Estimated Time:** XS (<15 min)
- **Files Affected:** `pages/order.html`
...
- [x] **Task:** Modal accessibility — roles and labelling
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Escape key closes modal
- **Priority:** Critical
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Body scroll lock while modal open
- **Priority:** High
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Favorite button accessibility
- **Priority:** High
- **Estimated Time:** XS (<15 min)
- **Files Affected:** `src/JS/modal.js`
...
- [x] **Task:** Form validation — `aria-invalid` and error text
- **Priority:** Critical
- **Estimated Time:** M (30–60 min)
...
- [x] **Task:** `aria-live` for loading and errors
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Buttons for actions, links for navigation
- **Priority:** High
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Responsive product grid
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Mobile full-screen modal
- **Priority:** Critical
- **Estimated Time:** M (30–60 min)
- **Files Affected:** `src/CSS/components.css`
- **Dependencies:** 2.3
...
- [x] **Task:** Responsive favorites page
- **Priority:** Medium
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Touch-friendly controls
- **Priority:** Medium
- **Estimated Time:** XS (<15 min)
- **Files Affected:** `src/CSS/components.css`
...
- [x] **Task:** Loading states (catalog, favorites, order)
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Error messages (catalog, favorites, order)
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** CSS animation — modal open/close
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
- **Files Affected:** `src/CSS/components.css`
...
- [x] **Task:** CSS animation — card hover (optional)
- **Priority:** Medium
- **Estimated Time:** XS (<15 min)
- **Files Affected:** `src/CSS/components.css`
...
- **Definition of Done:** All `image` paths in JSON resolve. No broken images in cards or modal.
  ...
  > **Blocker note:** Individual `.webp` product files are not in the repo yet. Cards and modal use `/images/placeholder.svg` as an accessible fallback when an image fails to load.

---

### 5.6 Empty favorites state

- [x] **Task:** Empty favorites state
- **Priority:** Medium
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Order success message (replace `alert`)
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Trust badge / footer consistency
- **Priority:** Low
- **Estimated Time:** XS (<15 min)
...
- [x] **Task:** Remove unused code (second pass)
- **Priority:** High
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Verify every assignment requirement
- **Priority:** Critical
- **Estimated Time:** S (15–30 min)
...
- [x] **Task:** Optional: add `netlify.toml`
- **Priority:** Low
- **Estimated Time:** XS (<15 min)
...
- [x] **Validated form** — Order form with visible validation errors
- [ ] **localStorage** — Favorites persist
- [ ] **localStorage** — Order count persists
- [ ] **Fetch JSON** — Catalog loads from `src/public/data/items.json` *(automated: preview returns 200 with 32 items; manual UI load not confirmed in browser)*
- [ ] **Dropdown or modal** — Order `<select>` present *(HTML verified in build output)*
- [ ] **Dropdown or modal** — Product detail modal implemented *(markup verified; manual open/close not confirmed)*
...
- [x] **JS modules** — Code split into organized modules
- [x] **Netlify-compatible Vite** — `npm run build` produces `dist/`
...
- [x] Run `npm run build` and preview `dist/`
